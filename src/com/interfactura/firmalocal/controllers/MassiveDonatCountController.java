...
@Controller
public class MassiveDonatCountController {
	...
	public MassiveDonatCountController(){
	...
	public void checkOK(){
		try{					
			...
			//FileOutputStream fileStatus = new FileOutputStream(properties.getPathFacturacionDonatProceso() + "STATUS_COUNT_" + nProceso + ".TXT");
			FileOutputStream userlog = null;
			FileOutputStream fileStatus = new FileOutputStream(facturacionDonatProceso + "massiveDonatCount.txt");
			fileStatus.write("Status del proceso bash massiveDonatCount.sh\n".getBytes("UTF-8"));
			String strID;
			int counter = 0;
			...
			e.printStackTrace();
			System.out.println("Exception massiveDonatCount:" + e.getMessage());
			try {
				//FileOutputStream fileError = new FileOutputStream(properties.getPathFacturacionDonatProceso() + "ERROR_COUNT_" + nProceso + ".TXT");
				FileOutputStream fileError = new FileOutputStream(facturacionDonatProceso + "massiveDonatCountError.txt");
				...
				System.out.println("Exception al crear massiveDonatCountError.txt:" + e.getMessage());
			}			
		}
	}
	...
	public void compressZip(String fileName) throws Exception{
		String zipFile = facturacionDonatSalida + "CIFRAS" + fileName + ".ZIP";
		
		String srcDir = facturacionDonatSalida  + fileName + "/";	
