...
@Controller
public class MassiveCountComplementoPagoController {
	@Autowired
	...
	public MassiveCountComplementoPagoController(){
	...
	public void checkOK(){
		try{					
			...
			FileOutputStream fileStatus = new FileOutputStream(PathFacturacionProceso + "massiveCount.txt");
			fileStatus.write("Status del proceso bash massiveCount.sh\n".getBytes("UTF-8"));
			String strID;
			int counter = 0;
			...
			try {
				...
				FileOutputStream fileError = new FileOutputStream(PathFacturacionProceso + "massiveCountError.txt");
	...
	public void compressZip(String fileName) throws Exception{
		String zipFile = PathFacturacionSalida + "CIFRAS" + fileName + ".ZIP";
		
		String srcDir = PathFacturacionSalida  + fileName + "/";	
