...
@Controller
public class MassiveGenerateIdsArrendadoraController {
	...
	public void readIdFileProcess(String file, String time){
		try{
			...
			if(fileProcesoTxt.exists()){
				FileOutputStream fileQuery = new FileOutputStream(PathArrendadoraProceso + fileName + "/IDSDIARIO" + fileName + "QUERY.SQL");
			...
			try {
				...
				FileOutputStream fileError = new FileOutputStream(PathArrendadoraProceso + "massiveIdsInvoiceError.txt");
