...
@Controller
public class MassiveReadComplementoPagoController {
	@Autowired
	...
	public static String PathFacturacionEntrada = "/salidas/masivo/complementoPago/facturacion/entrada/";
	public static String PathFacturacionProceso = "/salidas/masivo/complementoPago/facturacion/proceso/";
	public static String PathFacturacionSalida = "/salidas/masivo/complementoPago/facturacion/salida/";
	public static String PathFacturacionOndemand = "/salidas/masivo/complementoPago/facturacion/ondemand/";

	public MassiveReadComplementoPagoController() {
			...
			if (listRequest != null && listRequest.size() > 0) {
				for (Massive mObj : listRequest) {
					...
					userlog = new FileOutputStream(
							PathFacturacionSalida + mObj.getFilename() + "/LOG" + mObj.getFilename() + ".TXT");
														...
														try {
															...
															try {
																...
																try {
																	...
																	try {
																		System.out
																				.println("update massive: Intento 17");
																		massiveManager.update(massive);
																	} catch (Exception e17) {
																		try {
																			System.out.println(
																					"update massive: Intento 18");
																			massiveManager.update(massive);
																		} catch (Exception e18) {
																			try {
																				System.out.println(
																						"update massive: Intento 19");
																				massiveManager.update(massive);
																			} catch (Exception e19) {
																				try {
																					System.out.println(
																							"update massive: Intento 20");
																					massiveManager.update(massive);
																				} catch (Exception e20) {
																					e20.printStackTrace();
