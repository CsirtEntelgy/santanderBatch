...
import com.interfactura.firmalocal.xml.util.UtilCFDIDivisas;
...
@Component
public class GeneraDivisasXMLProceso_Masivo {
  ...
  //Banderas para comprobar que existan algunos atributos de Santander:Movimientos
	...
	@Autowired(required = true)
	private UtilCFDIDivisas fillDivisas;
	
	@Autowired
	private TagsXML tags;
	
   	public GeneraDivisasXMLProceso_Masivo() {
	 ...
	 * @param nameFile
	 */
	public GeneraDivisasXMLProceso_Masivo(String nameFile) {
			...
			while((strLine = br.readLine()) != null){
				...
				if(arrayRenglon.length>1){
					...
					if(user != null){
						...
						nombreUsuario = user.getUserName().trim();
					}
