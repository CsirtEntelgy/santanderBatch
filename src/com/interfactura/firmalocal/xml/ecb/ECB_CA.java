...
public class ECB_CA {
	...
	public List<MovimientoECB_CA> getLstMovimientosECB() {
		return lstMovimientosECB;
	}
	public void setLstMovimientosECB(List<MovimientoECB_CA> lstMovimientosECB) {
		this.lstMovimientosECB = lstMovimientosECB;
	}
	public EstadoDeCuentaBancario_CA getEstadoDeCuentaBancario() {
		return estadoDeCuentaBancario;
	}
	public void setEstadoDeCuentaBancario(EstadoDeCuentaBancario_CA estadoDeCuentaBancario) {
