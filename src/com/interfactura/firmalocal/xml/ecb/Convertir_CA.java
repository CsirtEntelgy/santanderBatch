...
@Component
public class Convertir_CA {

	private Logger logger = Logger.getLogger(Convertir_CA.class);
	...
	//public void set(String linea, long numberLine, String fileNames)
	{
		lineas = linea.split("\\|");
		...
		{	System.out.println("entra If");
			...
			tags.NOMBRE_APP_REPECB = NombreAplicativo_CA.obtieneNombreApp(hashApps, fileNames, numeroMalla); 
