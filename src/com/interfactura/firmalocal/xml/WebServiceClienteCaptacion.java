...
import com.interfactura.firmalocal.xml.timbradocaptacion.WebService1;
import com.interfactura.firmalocal.xml.timbradocaptacion.WebService1Soap;

@Component
public class WebServiceClienteCaptacion {
	private final static Logger logger = Logger.getLogger(com.interfactura.firmalocal.xml.WebServiceClienteCaptacion.class.getName());
   ...
   // private Properties properties;
    ...
    public String generaTimbre(String strXml, boolean regresaTimbre, String urlWebService, Properties properties, String nombreInterfaz, int numeroProceso, int tipoFormato, String periodo, String nombreAplicativo) throws IOException, UnsupportedEncodingException {
    	String xml = "";
        try {
            URL url = null;
            try {
                URL baseUrl;
                baseUrl = com.interfactura.firmalocal.xml.timbradocaptacion.WebService1.class.getResource(".");
    ...
    public WebServiceClienteCaptacion() {
