...
public class ReadExcelSaxDonat {
	...
	public static void main(String[] args) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("Exception massiveDonatExcel:" + e.getMessage());
			try {
				FileOutputStream fileError = new FileOutputStream(args[1] + "massiveDonatExcelError.txt");
				fileError.write((e.getMessage()).getBytes("UTF-8"));
				fileError.close();
			} catch (Exception e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
				System.out.println("Exception al crear massiveDonatExcelError.txt:" + e.getMessage());
			}			
		} 
	}
	...
	public static void readIdFileProcess(String pathFacturacionEntrada, String pathFacturacionProceso) throws Exception{
		...
		//String PathFacturacionDonatSalida="/salidas/masivo/divisas/facturacion/salida/";
		
		String PathFacturacionDonatSalida=MassiveDonatReadController.facturacionDonatSalida;
		...
		FileOutputStream fileStatus = new FileOutputStream(pathFacturacionProceso + "massiveDonatExcel.txt");
		fileStatus.write(("Status del proceso bash massiveDonatExcel.sh" + "\n").getBytes("UTF-8"));
		int counter = 0;
						...
						for(File file:fileDirectory.listFiles()){
				        	...
				        	if(strExt.toUpperCase().equals(".XLSX")){
								...
								if(finArchivo){
									...
									userlog = new FileOutputStream(PathFacturacionDonatSalida + arrayValues[1] + "/LOG" + arrayValues[1] + ".TXT",true);
