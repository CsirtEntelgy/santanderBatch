...
import com.interfactura.firmalocal.controllers.InvoiceController_WS;


public class Start_WS {
	private static Logger logger = Logger.getLogger(Start_WS.class);
	...
	public static void main(String[] args) 
	{
		...
		{			
			...
			InvoiceController_WS invoice = (InvoiceController_WS) factory.getBean(InvoiceController_WS.class);
