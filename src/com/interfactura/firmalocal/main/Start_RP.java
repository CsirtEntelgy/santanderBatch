...
import com.interfactura.firmalocal.controllers.InvoiceController_RP;

public class Start_RP {
	
	private static Logger logger = Logger.getLogger(Start_RP.class);
	...
	public static void main(String[] args) 
	{
		...
		{			
			...
			AbstractApplicationContext context = new ClassPathXmlApplicationContext(
					"app-config.xml", Start_RP.class);
			
			BeanFactory factory = (BeanFactory) context;
			context.registerShutdownHook();
			
			InvoiceController_RP invoice = (InvoiceController_RP) factory.getBean(InvoiceController_RP.class);
