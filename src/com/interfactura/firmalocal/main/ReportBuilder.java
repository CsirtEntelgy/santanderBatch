...
import com.interfactura.firmalocal.controllers.MassiveReportBuilderController;
	...
	public static void main(String[] args) {
		...
		try{
			...
			AbstractApplicationContext context = new ClassPathXmlApplicationContext(
					"app-config.xml", ReportBuilder.class);
			BeanFactory factory = (BeanFactory) context;
			context.registerShutdownHook();
			//logger.info("Paso 1.- Invocando a Procesar facturas para el proceso: " + args[6]);
			MassiveReportBuilderController builder = (MassiveReportBuilderController) factory.getBean(MassiveReportBuilderController.class);
			//if (args.length <= 7)
