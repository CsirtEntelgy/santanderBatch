...
public class OrderExtraction {
	...
	public static void main(String[] args) {
		...
		/*
		 * args[0] CuentasSelladas
		 * args[1] CuentasTotales
		 * args[2] CuentasSelladasOrdenadas
		 * args[3] validaOrdenError.txt
		 * */
		...
		try{
			...
			extraction(args[0].trim(), args[1].trim(), args[2].trim());
			...
			e.printStackTrace();
			System.out.println("Exception extractionAccountsOrganized:" + e.getMessage());
			try {				
				FileOutputStream fileError = new FileOutputStream(args[3].trim());
