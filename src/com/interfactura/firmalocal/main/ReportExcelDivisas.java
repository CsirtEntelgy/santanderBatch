...
import com.interfactura.firmalocal.controllers.MassiveReportExcelDivisasController;

public class ReportExcelDivisas {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try{
			...
			AbstractApplicationContext context = new ClassPathXmlApplicationContext(
					"app-config.xml", ReportExcelDivisas.class);
			BeanFactory factory = (BeanFactory) context;
			context.registerShutdownHook();
			//logger.info("Paso 1.- Invocando a Procesar facturas para el proceso: " + args[6]);
			MassiveReportExcelDivisasController excel = (MassiveReportExcelDivisasController) factory.getBean(MassiveReportExcelDivisasController.class);
			//if (args.length <= 7)
